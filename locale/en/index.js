const english = {
  ...
  footer: {
    ...
    demand: `Copyright ${new Date().getFullYear()}. All rights reserved.`,
    developers: "Web site developed by Sitelabs Company.",
    contactInformation: {
      title: "Information",
      email: "Email",
      phoneNumber: "Tel",
  ...
  service: {
    title: "Our Services",
    description: "Be educated so that you can change the world",
    serviceData: [
      {
        title: "Call Center",
        description:
