const uzbek = {
  ...
  contact: {
    ...
    email: "Iltimos elektron pochta manzilini kiriting",
  ...
  footer: {
    ...
    demand: `${new Date().getFullYear()} yil. Barcha huquqlar himoyalangan.`,
    developers: "Web sahifa Sitelabs Kompaniyasi tomonidan ishlab chiqildi.",
    contactInformation: {
      title: "Ma'lumotlar",
  ...
  service: {
    ...
    description: "Dunyoni o'zgartirishingiz uchun bilimli bo'ling",
    serviceData: [
      {
  ...
  about: {
    ...
    description:
      "Hayotda eng muhimi ishonch hisoblanadi.Biz bizga ishonch bildirganlarni ishonchini doim oqlashga harakat qilamiz",
    singleAbout: [
      [
        "Professional jamoa",
