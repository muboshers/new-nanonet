            ...
            <ul class="nav nav-tabs" role="tablist">
              ...
              <li>
                <a href="#p-view-4" role="tab" data-toggle="tab">
                  <span class="cha-title">Web developement</span>
                </a>
              </li>
            </ul>
          </div>
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="machine-text">
                      ...
                      <p>
                        ...
                        content of dummy text is nonsensical. used to
                      ...
                      <ul>
                        <li>
                          <a href="#"
                            >Innovation idea latest business tecnology</a
                          >
                        </li>
                        <li>
                          <a href="#"
                            >Digital content marketing online clients
                            plateform</a
                          >
                        </li>
                        <li>
                          <a href="#"
                            >Safe secure services for you online email
                            account</a
                          >
                        </li>
                        <li>
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="machine-text">
                      ...
                      <p>
                        ...
                        used to demonstrate the appearance of different
                        typefaces and layouts, and in general the content of
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="machine-text">
                      ...
                      <p>
                        Used to demonstrate the appearance of different
                        typefaces and layouts, and in general the content of
                        dummy text is nonsensical. text is also used to
                        demonstrate the appearance of different typefaces and
                        layouts, and in general the content of dummy text is
                        nonsensical
                      </p>
                ...
                <div class="single-machine row">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="machine-text">
                      ...
                      <p>
                        Dummy text is also used. used to demonstrate the
                        appearance of different typefaces and layouts, and in
                        general the content of dummy text is nonsensica to
                        demonstrate the appearance of different typefaces and
                        layouts, and in general the content of dummy text is
                        nonsensical.
                      </p>
